          ...
          {streams.map((stream) => (
            ...
            >
              <img
                ...
                className="transition-all hover:translate-x-1 hover:-translate-y-1 hover:shadow-[-5px_5px_#772ce8,-4px_4px_#772ce8,-3px_3px_#772ce8,-2px_2px_#772ce8,-1px_1px_#772ce8]"
              />
