...
export const data = {
  ...
  servers: [
    {
      name: 'crawl.roguelikes.gg',
      abbreviation: 'CRG',
      url: 'https://crawl.roguelikes.gg',
      baseUrl: 'https://crawl.roguelikes.gg',
      morgueUrl: 'https://crawl.roguelikes.gg/morgue',
      ttyrecUrl: 'https://crawl.roguelikes.gg/ttyrec',
      logfiles: [
