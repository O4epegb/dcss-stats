  ...
  return (
    <div className="container mx-auto flex min-h-screen flex-col items-center px-4 pt-8 md:justify-center md:pt-0">
      <div className="w-full max-w-lg space-y-4">
        ...
        />
        <a
          href="https://crawl.develz.org/tournament/0.28/"
          rel="noreferrer"
          target="_blank"
          className="flex items-center justify-center gap-4 rounded bg-indigo-100 py-2 px-4 transition-colors hover:bg-indigo-200"
        >
          <div className="text-4xl">🏆</div>
          <div className="flex items-center gap-1">
            Dungeon Crawl Stone Soup v0.28 Tournament
            <svg
